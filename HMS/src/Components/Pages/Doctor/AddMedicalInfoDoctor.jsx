...
const AddMedicalInfoDoctor = ({ setToggle,AddMedicalRecord,refreshMedicalRecords }) => {
    const [AddMedicalInfo, { isLoading }] = usePostQueryMutation()
    ...
    const handleSubmit = useCallback(async (e) => {
        ...
        try {
            const response = await AddMedicalInfo({ url: 'medicalrecord/createmedicalrecord/', token: getToken().access, submission: { ...form, patient: patientID } })
            ...
            if(response.data.message) {
                ...
                setTimeout(()=>{
                    ...
                    const res = refreshMedicalRecords()
...
export default AddMedicalInfoDoctor